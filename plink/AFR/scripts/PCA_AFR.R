...
# run PCA
system("/Users/clarkao1/Documents/ML4FG_project/plink/plink --bfile AFR_ready --pca --out pca")
...
ggplot(data = eigenvecs) + 
  ...
  labs(title = "PCA of African American Individuals",
...
ggplot(data = eigenvals) + 
  ...
  labs(title="Scree Plot",
       subtitle = "African American Individuals",
       x = "Component",
